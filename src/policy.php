  ...
  <div class="wrapper">
    ...
    <section class="section-president" id="president">
      ...
      <div class="inner">
        <div class="head-shot">
          ...
          <a class="banner" href="<?php echo home_url('motojuku') ?>">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pages/motojuku/img_about001.png" alt="茂藤雅彦">
            <p>サロンオーナーのための「エステ経営 学び塾」　≫詳しく見る</p>
          </a>
        </div>
        ...
        <section>
          ...
          グループの中核企業である株式会社クールプロジェクトは金沢に本社を、石川、富山、福井の北陸3県に実店舗のエステサロンを、東京（銀座）支社には海外事業部を、富山市山室に研修センターを展開しています。美容産業の川上から川下にいたるまで、幅広い顧客にハード面（PB／OEM美容機器、化粧品の製造・販売）からソフト面（コンサルティング・エステティックサービス）までワンストップサービスを提供しています。今後も当該事業の国内外活動を通して社会貢献を果たし、企業市民として信頼の醸成に努めると共に、さらなる事業の発展に邁進して参る所存です。
          </p>
        </section>
      </div>
    </section>
    ...
    <section class="section-social" id="social">
      ...
      <div class="description">
        <p>私共クールエステティックグループは、おかげさまで本年創業16周年を迎えます。富山県、石川県、福井県の北陸三県を中心に、東京・銀座にても事業展開を行なっています。これまでオリコン「顧客満足度ランキング」全国エステサロン部門にて、3年連続（2010-2011-2012年度）「特別推奨サロン」に選ばれました。<br>

...
<main class="guide">
  ...
  <section class="section-chart" id="chart">
    ...
    <figure>
      <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pages/guide/img_chart.png" alt="クールプロジェクト組織図">
    </figure>
  </section>

  <section class="section-depart" id="depart">
    <header>
    ...
    <div class="section-guide-wrap">
      <section class="section-guide" id="esthetique">
        <header>
        ...
        <div class="icon">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pages/guide/img_esthetique.svg" alt="">
        </div>

        <p>COEUR(クール）＝フランス語で「こころ」の意味<br>
        クールエステティック起業の原点は、お客様を思いやる“こころ”。<br>
        その思いを一心に、店名〝クール〟にこめました。<br>
        ・トータルビューティ「クールエステティック」<br>
        ・フェイシャル専門サロン「クールフェイシャルボーテ」<br>
        ・痩身専門サロン「クールグランボディ」<br>
      ...
      <section class="section-guide" id="fc">
        ...
        <div class="icon">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pages/guide/img_franchise.svg" alt="">
        </div>

        <p>クールエステティック・ブランドの国内外フランチャイズ・マネジメント<br>
        ・新人教育研修<br>
        ・技術・サービス研修<br>
        ・顧客管理<br>
        ・サロン運営管理<br>
      ...
      <section class="section-guide" id="consulting">
        ...
        <div class="icon">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pages/guide/img_consulting.svg" alt="">
        </div>

        <p>＊エステティックコンサルティング<br>
        ＊新規開業コンサルティング<br>
        ＊新人研修セミナー開催、運営<br>
        ＊勝ち組サロン経営術「茂藤塾」開講<br>
        ＊サロン施術（脱毛、痩身、フェイシャル）セミナー開催、運営<br>
      ...
      <section class="section-guide" id="products">
        ...
        <div class="icon">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pages/guide/img_products.svg" alt="">
        </div>

        <p>＊ディーラーグループ<br>
        　エステサロン向けに各種商材の卸・販売<br>
        ＊PB（プライベートブランド）グループ<br>
        　自主企画製品（美容機器、化粧品）を展開<br>
        ＊OEMグループ<br>
        　国内外のサロンにOEM化粧品を展開</p>
      ...
      <section class="section-guide" id="ec">
        ...
        <div class="icon">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pages/guide/img_ec.svg" alt="">
        </div>

        <p>＊ECサイト「ココセレ」運営<br>
        クールエステティックがセレクトした美容機器＆化粧品＆サプリメント等、一般商品を販売するビューティ通販サイト。<br>
        <br>
        ＊ECサイト「クールBtoBオンラインショップ」運営<br>
      ...
      <section class="section-guide" id="bio">
        ...
        <div class="icon">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pages/guide/img_bio.svg" alt="">
        </div>

        <p>＊純植物性バイオ冬虫夏草食品「北虫草(ほくちゅうそう)」日本総販売元<br>
      ...
      <section class="section-guide" id="overseas">
        ...
        <div class="icon">
          <img src="<?php echo get_stylesheet_directory_uri(); ?>/images/pages/guide/img_overseas.svg" alt="">
        </div>
